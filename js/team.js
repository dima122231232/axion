gsap.to(".team__photo", {y: "30%",ease: "none",scrollTrigger: {trigger: ".team__photo-block",start: "top bottom",end: () => `bottom+=${1*vh} top`,scrub: true}});
...
animateWords(".team__title", ".team", "top 70%");