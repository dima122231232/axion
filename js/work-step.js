if (!isMobile) {
  ...
  gsap.fromTo(".work-steps-h2", { opacity: 0, scale: .9, y: 300 }, { y: 0, scale: 1, opacity: .75, duration: .4, scrollTrigger: { trigger: ".work-steps__item", start: "top 50%", toggleActions: "play none none reverse" }});
  ...
  gsap.fromTo(".work__block-blur, .work-steps-h2", { opacity: .75 }, { opacity: 1, scrollTrigger: {trigger: ".about", start: "-100% top", end:"-25% top", scrub: true}});
