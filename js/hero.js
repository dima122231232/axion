    if(!isMobile){gsap.fromTo(".promo__video",{scale:.3,rotate:-5,y:"-10vw"},{scale: 1,y:"100vh",rotate:0,scrollTrigger: {trigger: ".hero",start: "top top",end: "center top",scrub: true}});}
        ...
        gsap.fromTo(".promo__video",{scale:.3,rotate:0,y:-.3*vw},{scale: 1,y:1.1*vh,rotate:0,force3D: true,scrollTrigger: {trigger: ".hero",start: "top top",end: "center top",scrub: true}});
    } 
